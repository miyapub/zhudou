...
?>
        ...
        <div class="box">
          ...
          <?
$sql ="SELECT comments.id as comment_id,comments.time as time,users.id as user_id,users.name as user_name,users.avatar as avatar,comments.text as comment_text,projects.id as project_id,projects.title as project_title,projects.pic as project_pic,projects.text as project_text FROM comments,users,projects where comments.created_by=users.id AND comments.project_id=projects.id order by comments.id desc";
