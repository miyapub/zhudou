...
if (isset($_GET['id'])) {
    ...
    <div>
        ...
        $sql ="SELECT users.id as user_id,comments.text as comment,comments.pic as pic,comments.ip as ip,users.name as user_name FROM `users`,`comments` WHERE users.id=comments.created_by and `comments`.project_id=$project_id";
        $result = mysql_query($sql,$conn); //查询
